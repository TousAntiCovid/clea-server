Feature: Several healthy visitors visit different places
  ...
  Background:
    ...
    Given "La fontaine aux perles" created a dynamic QRCode at 04:00, 10 days ago with VType as "restaurant" and with VCategory1 as 1 and with VCategory2 as 1 and with a renewal time of "15 minutes" and with a periodDuration of "24 hours"
