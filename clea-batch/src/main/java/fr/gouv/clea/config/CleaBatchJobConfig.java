...
public class CleaBatchJobConfig {
    ...
    @Bean
    public Job cleaBatchJob(Step clusterIdentification, Step clustersIndexation, Step prefixesComputing,
            Step purgeIntermediateTable, Step clusterIndexGeneration) {
