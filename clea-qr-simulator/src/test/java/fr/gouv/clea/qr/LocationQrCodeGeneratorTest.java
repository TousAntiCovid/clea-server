...
public class LocationQrCodeGeneratorTest {
    ...
    public void shouldBeSameTLid() throws Exception {
        ...
        assertThat(qr.getLocationTemporaryPublicID().toString())
                .isEqualTo(qr2.getLocationTemporaryPublicID().toString());
    ...
    public void startingNewPeriod() throws Exception {
        ...
        assertThat(qr.getLocationTemporaryPublicID().toString())
                .isNotEqualTo(qr2.getLocationTemporaryPublicID().toString());
