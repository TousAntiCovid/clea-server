...
/**
 * I compare rules MATCHING a given tuple (venue type, venue categrory1, venue
 * category 2). I cannot be used to compare rules not mathcing the same tuple.
 */
public class ScoringRuleComparator implements Comparator<ScoringRule> {
    ...
    public int compare(ScoringRule rule1, ScoringRule rule2) {
        ...
        // No check on venue type : Wildcard on venue type is not allowed except for the
        // default rule
